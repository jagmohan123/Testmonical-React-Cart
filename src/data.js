const reviews = [
  {
    id: 1,
    name: "Mohit Dubey",
    job: "Software Engineer at JIO",
    image: "https://aeccc.targettechnology.in/static/media/PranayGupta.f3c530b7630ba8efb2ab.jpg",
    text: "I have had the pleasure of working with this Jio team on several projects, and I am consistently impressed with their technical expertise and ability to deliver quality solutions on time and within budget. They are a true partner and an asset to any project.",
  },
  {
    id: 2,
    name: "Sourav Patel at Infosys",
    job: "Specilist Engineer",
  ...
  },
  {
    id: 4,
    name: "Tanishq Patel",
    job: "Software Tester at Persistence",
  ...
  },
  {
    id: 5,
    name: "Jagmohan Rai ",
    job: "Ex Member Technical at ADP, Wipro Project Engineer Intern and Hcl GET Intern",
